            ...
            <section className="content">
                ...
                <div className="content__card-flex">
                    <div className="content__card">
                        ...
                        <p className="content__subtitle">Мужские Кроссовки Nike Blazer Mid Suede</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>12 999 руб.</b>
                            </div>
                            <button className="content__btn">
                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10.6653 5.13122H7.20215V1.66821C7.20215 0.332846 5.13115 0.332846 5.13115 1.66821V5.13122H1.66802C0.332951 5.13122 0.332951 7.20215 1.66802 7.20215H5.13115V10.6652C5.13115 12.0005 7.20215 12.0005 7.20215 10.6652V7.20215H10.6653C12.0005 7.20215 12.0005 5.13122 10.6653 5.13122Z"
                                        fill="#D3D3D3"
                                    />
                                </svg>
                            </button>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image2.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Nike Air Max 270</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>12 999 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image1.jpg" alt="" />
                        <p className="content__subtitle">Кроссовки Puma X Aka Boku Future Rider</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>8 999 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image1.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Under Armour Curry 8</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>15 199 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image1.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Nike Kyrie 7</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>11 299 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image7.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Jordan Air Jordan 11</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>10 799 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image8.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Nike LeBron XVIII</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>16 499 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image9.jpg" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Nike Lebron XVIII Low</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>13 999 руб.</b>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image10.png" alt="" />
                        <p className="content__subtitle">Кроссовки Puma X Aka Boku Future Rider</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                    ...
                    <div className="content__card">
                        <img width={133} height={112} src="/img/sneakers/image12.png" alt="" />
                        <p className="content__subtitle">Мужские Кроссовки Nike Kyrie Flytrap IV</p>
                        <div className="content__bottom">
                            <div className="content__bottom-price">
                                <p>Цена:</p>
                                <b>11 299 руб.</b>
